...
**Not an authoritative deletion list.** Rows reflect a **static** approximation: test string references to `test/fixtures/...` plus transitive `include` / `import` edges resolved like `src/sourceIncludePaths.ts` with assumed `-I` directories:
