...
- **CLI contract:** `pr249_cli_lock_eviction_matrix` (`cli_artifacts`, `cli_determinism_contract`, `cli_path_parity_contract` **ported**).
...
10. CLI contract tests (`pr249_cli_lock_eviction_matrix` remaining; **cli_artifacts**, **cli_determinism_contract**, **cli_path_parity_contract** ported).
